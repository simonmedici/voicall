...
const plans = [
  {
    ...
    popular: false,
    features: [
      "200 Minuten inklusive (danach 0.25/Min)",
      "Ein Voice Bot",
      "Sprache: Deutsch",
  ...
  },
  {
    ...
    popular: true,
    features: [
      "1000 Minuten inklusive (danach 0.25/Min)",
    ...
    <section id="pricing" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-center text-sm text-gray-500 mb-12">
          *zzgl. einmalige Setup Fee (CHF 500 – 2'500), abhängig von der Komplexität der Integration
        </p>
